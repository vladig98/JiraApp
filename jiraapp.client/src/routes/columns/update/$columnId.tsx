...
export const Route = createFileRoute('/columns/update/$columnId')({
...
function EditColumnPage() {
    ...
    async function handleSubmit(e: React.SubmitEvent) {
        ...
        const updatedColumn = { ...originalColumn, name: title.trim() };
        upsertColumn(updatedColumn, boardId);
        ...
        try {
            ...
            setApiError("The server rejected the new column name. No changes were made.");
            ...
            <div className="flex flex-col min-h-screen bg-slate-50/50">
                ...
                <header className="px-8 py-6 border-b border-slate-200 bg-white">
                    <nav className="text-xs text-slate-500 mb-1 uppercase tracking-wider font-bold">
                        Projects / Boards / {boardId} / Columns / {columnId} / Edit
                    </nav>
                    <h1 className="text-2xl font-semibold text-slate-900">Edit Column</h1>
                </header>
                    ...
                    <div className="w-full max-w-2xl bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
                        <form onSubmit={handleSubmit} className="p-8 space-y-8">
                            ...
                            <div className="flex items-center justify-end gap-4 pt-6 border-t border-slate-100">
                                ...
                                >
                                    {isSubmitting ? 'Updating...' : 'Edit Column'}
                                </button>
                            </div>
                        </form>
                    </div>
